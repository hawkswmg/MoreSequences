...
def run_test_make_simple_string():
    ...
    actual = make_simple_string(12,17)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 2:
    expected = '41-42-43-44-45-46-47-48-49-'
    actual = make_simple_string(41,49)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '41-42-43-44-45-46-47-48-49'
    actual = make_less_simple_string(41, 49)
    print('Expected:', expected)
    print('Actual:  ', actual)
